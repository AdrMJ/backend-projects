...
public class BookConstants {
	...
	//Messages by variable in ImageUrl class
	public static final String IMAGE_URL_LENGTH_MESSAGE = "The length of the url must be between 3 and 223 characters";
	public static final String COLOR_LENGTH_MESSAGE = "The length of the \"color\" must be between 3 and 50 characters";
	
	//Messages by variable in IntroWords class
	public static final String INTRO_WORDS_LENGTH_MESSAGE = "The length of the \"intro words\" must be between 3 and 2000 characters";
	public static final String AUTHOR_OF_WORDS_LENGTH_MESSAGE = "The length of the \"author of the words\" must be between 3 and 100 characters";
	...
	public static final String LANGUAGE_LENGTH_MESSAGE = "The length of the language must be between 3 and 50 characters";
	public static final String PUBLISHER_LOGO_LENGTH_MESSAGE = "The length of the publisher' s logo must be between 3 and 223 characters";
	public static final String PUBLISHER_URL_LENGTH_MESSAGE = "The length of the publisher's url must be between 3 and 223 characters";
	...
	public static final String CORRECT_DATE_MESSAGE = "The correct date is between 2020.05.12 and now";
