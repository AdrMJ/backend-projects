...
public class BookTests {
	...
	// imageUrl test methods

		@Test
		public void shouldSetAndRetrieveImageUrlMatches() {
			emptyBook.setImageUrl(imageUrl);

			assertEquals(imageUrl, emptyBook.getImageUrl());
		}

		@Test
		public void shouldFailWhenImageUrlIsNull() {
			emptyBook.setImageUrl(null);
