...
public class IntroWordsTests {
	...
	public void shouldSetAndRetrieveAuthorOfWordsMatches() {
		String authorOfWords = "authorOfWords";
	...
	//book_id test methods
	
	@Test
	public void shouldSetAndRetrieveBookIdMatches() {
		Integer bookId = 1;
		emptyIntroWords.setBookId(bookId);

		assertEquals(bookId, emptyIntroWords.getBookId());
	}

	@Test
	public void shouldFailWhenBookIdIsNull() {
		emptyIntroWords.setBookId(null);
